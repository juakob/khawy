...
class TextAnimated extends Text
{
	...
	public function new(type:String,text:String, aWidth:Float, aHeigthSeparation:Float=10, aSeparation:Float=1,transitionFunction:Component->Int->Array<ITransition>) 
	{
