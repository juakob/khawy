...
class DebugDisplay implements IDraw {
	...
	public function render(paintMode:PaintMode, t:FastMatrix4):Void {
        ...
        paintMode.render();
		GEngine.i.endCanvas();
        GEngine.i.currentCanvas().g2.transformation=FastMatrix3.scale(scaleWidth,scaleHeigth).multmat(new FastMatrix3(t._00,t._10,t._30,t._01,t._11,t._31,t._02,t._12,t._22));
