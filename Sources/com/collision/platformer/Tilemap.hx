...
class Tilemap {
    ...
    public function init(tmxData:String,tilesImg:String,tileWidth:Int,tileHeight:Int,displayLayer:Layer,scale:Float=1):CollisionTileMap {
				...
				case TmxLayer.LTileLayer(tileMap):
					{
						//if (!tileMap.properties.exists("collision")) {
							...
							collision=new CollisionTileMap(tiles,tileWidth*scale,tileHeight*scale,tileMap.width, tileMap.height ) ;
					//	}
